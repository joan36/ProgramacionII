...
public class Tauler extends JPanel {
    ...
    private static float vermell =(float) Math.random();
    private static float blau =(float) Math.random();
    private static float verd =(float) Math.random();
...
//                    g2d.setColor(BLANC);
                    g2d.setColor(new  java.awt.Color(verd,blau,vermell));
                } else {
                    g2d.setColor(NEGRE);
